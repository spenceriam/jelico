...
- **Latest Release (0.36.0)**: Minor release focused on durable queued-message management, startup-safe queue hydration, inline queue controls, and direct editing/regenerate flow improvements for the latest prompt
