...
const PROVIDER_TYPES: ProviderOption[] = [
  ...
  },
  {
    ...
    type: 'openai-compatible' as const,
    group: 'Hosted APIs',
    name: 'Alibaba Qwen Intl',
    cardTitle: 'Alibaba Qwen International',
    summary: 'Singapore-region DashScope compatible endpoint for Qwen.',
    icon: 'Q',
    defaultModel: 'qwen3.5-plus',
    defaultBaseUrl: 'https://dashscope-intl.aliyuncs.com/compatible-mode/v1',
    defaultProviderName: 'Alibaba Qwen International',
  ...
  },
  {
    ...
    cardTitle: 'Alibaba Qwen US',
    summary: 'Virginia-region DashScope compatible endpoint for -us Qwen models.',
    icon: 'Q',
    defaultModel: 'qwen-plus-us',
    defaultBaseUrl: 'https://dashscope-us.aliyuncs.com/compatible-mode/v1',
    defaultProviderName: 'Alibaba Qwen US',
    apiKeyUrl: 'modelstudio.console.alibabacloud.com',
    docsUrl: 'https://www.alibabacloud.com/help/en/model-studio/regions/',
  },
  {
    id: 'alibaba-qwen-china',
    type: 'openai-compatible' as const,
    group: 'Hosted APIs',
    name: 'Alibaba Qwen China',
    cardTitle: 'Alibaba Qwen China',
    summary: 'Beijing-region DashScope compatible endpoint for Qwen.',
    icon: 'Q',
    defaultModel: 'qwen-plus',
    defaultBaseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1',
    defaultProviderName: 'Alibaba Qwen China',
    apiKeyUrl: 'bailian.console.aliyun.com',
    docsUrl: 'https://www.alibabacloud.com/help/en/model-studio/regions/',
  },
  {
    id: 'nvidia',
